...
calculate(showResult.bind(this, 'The result after adding all numbers is:'), 'ADD', 2, 4, 4);
calculate(showResult.bind(this, 'The result after sutracting all numbers is:'), 'SUBTRACT', 2,4,7);
